...
const embedBotCommands = new EmbedBuilder()
	...
	.addFields(
		...
		},
		{
			name: '/embed',
			value:
				'ㅤ  Отправляет ваше сообщение как вложенное\nㅤ  *Параметры:*\nㅤ  ▫️ Title - Заголовок вложенного сообщения\nㅤ  ▫️ Description - Описание вложенного сообщения\nㅤ  ▫️ Color - Не обязательный параметр, цвет вложенного сообщенияㅤ\nㅤ  ',
			inline: false,
		},
		{
			name: '/ping',
